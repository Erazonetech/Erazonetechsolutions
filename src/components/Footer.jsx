...
function Footer() {
  return (
    <footer className="w-full bg-slate-950 border-t border-slate-800">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <div className="flex flex-col gap-4 text-slate-400">
            ...
            <Link className="hover:text-teal-400 transition" to="/technologies">
              Technologies
            </Link>
            <Link className="hover:text-teal-400 transition" to="/portfolios">
              Portfolios
            </Link>
            <Link className="hover:text-teal-400 transition" to="/about">
              About
            </Link>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-5 text-slate-400">
            ...
            <div className="flex items-start gap-3">
              ...
              <span>+251 45 01 08 57</span>
            </div>

            <div className="flex items-start gap-3">
              <Mail size={18} className="text-teal-400 mt-1" />
              <span>contact@erazonetech.com</span>
            </div>
      ...
      <div className="border-t border-slate-800 py-6 text-center text-slate-500 text-sm">
        © {new Date().getFullYear()} ERAZONE Technologies. All rights reserved.
      </div>
