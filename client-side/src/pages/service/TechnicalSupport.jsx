    ...
    <div className='mt-40 mx-20 mb-20'>
       <div className='flex justify-between'>
           <div className='max-w-[50%]'>
            ...
            <p className='text-xl text-gray-700 mt-5'>Our dedicated technical support team is here to assist you with any issues, ensuring seamless solutions 24/7. Count on us for reliable, expert guidance whenever you need it.</p>
           </div>
           {/* <div className='shadow-red-200'>
           </div> */}
           <img className='bg-[#afaaaa] transition-all duration-200 shadow-sm hover:shadow-lg hover:shadow-orange-800 rounded-2xl w-[40%] h-[350px]' src="/support.jpg" alt="Mobile dev" />
        </div>
